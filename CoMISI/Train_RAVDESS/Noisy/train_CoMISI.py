...
from CrossModalRelationModel import MultimodalNetworkCoMISI
...
def train_and_evaluate(model, train_loader, val_loader, test_loader):
    ...
    best_model_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/CoMISI/weights/best_model_comisi_ravdess_noise.pth'  # Path to save the best model
...
if __name__ == "__main__":
    ...
    for run in range(NUM_RUNS):
        ...
        model = MultimodalNetworkCoMISI(dropout_rate=0.5)  # Ensure MultimodalNetwork is correctly defined/imported
    ...
    results_file_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/Results/CoMISI/RAVDESS/noise/CoMISI_Results.txt'  # Adjust the path as necessary
