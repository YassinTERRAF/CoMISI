...
# Load data
train_dataset = VisualDataset(csv_file='.../features/CoMISI/Ravdess/Noise/train_features.csv')
val_dataset = VisualDataset(csv_file='.../features/CoMISI/Ravdess/Noise/val_features.csv')
test_dataset = VisualDataset(csv_file='.../features/CoMISI/Ravdess/Noise/test_features.csv')
...
def train_and_evaluate(model, train_loader, val_loader, test_loader):
    ...
    best_model_path = '.../CoMISI/weights/best_model_single_visual_ravdess_noise.pth'  # Path to save the best model
...
if __name__ == "__main__":
    ...
    results_file_path = '.../Results/CoMISI/RAVDESS/noise/Single_Visual_Results.txt'  # Adjust the path as necessary
