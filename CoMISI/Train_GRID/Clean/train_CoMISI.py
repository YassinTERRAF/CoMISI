...
def train_and_evaluate(model, train_loader, val_loader, test_loader, patience=5):
    ...
    best_model_path = '.../CoMISI/weights/best_model_comisi_Grid_clean.pth'
...
if __name__ == "__main__":
    ...
    results_file_path = '.../Results/CoMISI/GRID/clean/CoMISI_Results.txt'  # Adjust the path as necessary
