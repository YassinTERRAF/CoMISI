...
def train_and_evaluate(model, train_loader, val_loader, test_loader):
    ...
    best_model_path = '.../CoMISI/weights/best_model_score_Grid_noise.pth'  # Path to save the best model
...
if __name__ == "__main__":
    ...
    results_file_path = '.../Results/CoMISI/Grid/noise/score_level_Results.txt'  # Adjust the path as necessary
