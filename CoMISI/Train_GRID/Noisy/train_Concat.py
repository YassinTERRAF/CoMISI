...
def train_and_evaluate(model, train_loader, val_loader, test_loader):
    ...
    best_model_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/CoMISI/weights/best_model_concat_Grid_noise.pth'  # Path to save the best model
...
if __name__ == "__main__":
    ...
    results_file_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/Results/CoMISI/Grid/noise/Simple_Concat_Results.txt'  # Adjust the path as necessary
