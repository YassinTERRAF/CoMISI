...
# Load data
train_dataset = AudioDataset(csv_file='.../features/CoMISI/Grid/Noise/train_features.csv')
val_dataset = AudioDataset(csv_file='.../features/CoMISI/Grid/Noise/val_features.csv')
test_dataset = AudioDataset(csv_file='.../features/CoMISI/Grid/Noise/test_features.csv')
...
def train_and_evaluate(model, train_loader, val_loader, test_loader):
    ...
    best_model_path = '.../CoMISI/weights/best_model_single_audio_Grid_noise.pth'  # Path to save the best model
...
if __name__ == "__main__":
    ...
    results_file_path = '.../Results/CoMISI/Grid/noise/Single_Audio_Results.txt'  # Adjust the path as necessary
