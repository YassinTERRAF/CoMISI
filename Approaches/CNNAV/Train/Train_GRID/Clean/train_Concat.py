...
class MultimodalDataset(Dataset):
    def __init__(self, csv_file):
        self.dataframe = pd.read_csv(csv_file, skiprows=[1386])
...
# Load data
train_dataset = MultimodalDataset(csv_file='lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/features/CNNAV/Grid/Clean/train_features.csv')
val_dataset = MultimodalDataset(csv_file='lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/features/CNNAV/Grid/Clean/val_features.csv')
test_dataset = MultimodalDataset(csv_file='lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/features/CNNAV/Grid/Clean/test_features.csv')
...
def train_and_evaluate(model, train_loader, val_loader, test_loader, patience=10):
    ...
    best_model_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/Approaches/CNNAV/weights/best_model_concat_Grid_clean.pth'
    epochs_no_improve = 0
...
if __name__ == "__main__":
    ...
    results_file_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/Results/CNNAV/Grid/clean/results.txt'  # Adjust the path as necessary
