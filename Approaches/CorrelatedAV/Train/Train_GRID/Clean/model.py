...
class MultimodalNetwork(nn.Module):
    def __init__(self, dropout_rate=0.5):
        ...
        # Audio branch
        self.audio_fc1 = nn.Linear(375, self.embed_size)
        self.audio_fc2 = nn.Linear(self.embed_size, 34)  # Assuming 34 classes

        # Visual branch
        self.visual_fc1 = nn.Linear(512, self.embed_size)
        self.dropout1 = nn.Dropout(dropout_rate)  # Second dropout layer

        self.visual_fc2 = nn.Linear(self.embed_size, 34)  # Assuming 34 classes
