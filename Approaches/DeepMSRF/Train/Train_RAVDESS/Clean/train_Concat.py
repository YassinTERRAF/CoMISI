...
# Load data
train_dataset = MultimodalDataset(csv_file='lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/features/DeepMSRF/Ravdess/Clean/train_features.csv')
val_dataset = MultimodalDataset(csv_file='lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/features/DeepMSRF/Ravdess/Clean/val_features.csv')
test_dataset = MultimodalDataset(csv_file='lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/features/DeepMSRF/Ravdess/Clean/test_features.csv')
...
def train_and_evaluate(model, train_loader, val_loader, test_loader, patience=10):
    ...
    best_model_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/Approaches/DeepMSRF/weights/best_model_concat_Ravdess_clean.pth'
    epochs_no_improve = 0
...
if __name__ == "__main__":
    ...
    results_file_path = 'lustre/rsc_mgt_wi-st-sccs-lj7uaansp4q/users/yassin.terraf/multimodal_speaker_recognition/Results/DeepMSRF/Ravdess/clean/results.txt'  # Adjust the path as necessary
